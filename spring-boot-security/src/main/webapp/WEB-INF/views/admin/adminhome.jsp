...
<link rel="stylesheet"
	...
	crossorigin="anonymous">
<title>HomeMade Spices And Snacks
</title>
<style >
 body{
			...
			<div class="col-sm-3 pt-4">
				<div class="card border border-info" style="background-color: white;">
					<div class="card-body text-center">
						...
						<a href="/admin/products" class="card-link btn btn-primary">Add</a>
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<a href="/products/prolist" class="card-link btn btn-primary">Manage</a>
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<a href="/admin/customers" class="card-link btn btn-primary">Update profile</a>
